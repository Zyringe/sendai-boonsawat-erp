...
2. **Identify the backup to restore.** Daily, monthly, and yearly snapshots live under:
   - `/Users/putty/Documents/Sendai-Boonsawat/ERP/data/backups/inventory-YYYY-MM-DD.db`
   - `/Users/putty/Documents/Sendai-Boonsawat/ERP/data/backups/monthly/inventory-YYYY-MM.db`
   - `/Users/putty/Documents/Sendai-Boonsawat/ERP/data/backups/yearly/inventory-YYYY.db`

   List candidates with row counts:
   ```
   for f in /Users/putty/Documents/Sendai-Boonsawat/ERP/data/backups/inventory-*.db; do
       echo "$f"
...
1. **Move the current live DB aside** (do not delete — keep as recovery point).
   ```
   LIVE=/Users/putty/Documents/Sendai-Boonsawat/ERP/inventory_app/instance/inventory.db
...
2. **Copy the backup into place.** Plain `cp` is fine here because the live file is no longer in use.
   ```
   cp /Users/putty/Documents/Sendai-Boonsawat/ERP/data/backups/inventory-YYYY-MM-DD.db "$LIVE"
   ```
3. **Verify.**
   ```
...
```
mv /Users/putty/Documents/Sendai-Boonsawat/ERP/inventory_app/instance/inventory.db \
   /Users/putty/Documents/Sendai-Boonsawat/ERP/inventory_app/instance/inventory.db.failed-restore
mv /Users/putty/Documents/Sendai-Boonsawat/ERP/inventory_app/instance/inventory.db.before-restore-* \
   /Users/putty/Documents/Sendai-Boonsawat/ERP/inventory_app/instance/inventory.db
```
