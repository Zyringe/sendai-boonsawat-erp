# Sendy Deploy & Auth Reference — Sendai Boonsawat

Reference สำหรับ deploy **Sendy** (Flask ERP) ขึ้น Railway และจัดการระบบ auth หลายระดับ
...
ดู `/erp-permissions` สำหรับ role hierarchy, POST whitelist, `inject_auth` context processor, simulate role
